...
import 'emergency_profile_page.dart';
...
import 'package:libphonenumber/libphonenumber.dart';  // Add this importt
...
class _LoginRegisterState extends State<LoginRegister> {
  ...
  void sendAndCheckOTP() async {
      try {
        final phoneNumber = "+251 ${_phoneNumberController.text}";
        final formattedPhoneNumber = await PhoneNumberUtil.isValidPhoneNumber(isoCode: "ET", phoneNumber: phoneNumber);
        final newNumber = await PhoneNumberUtil.normalizePhoneNumber(isoCode: "ET", phoneNumber: phoneNumber);
        log(formattedPhoneNumber.toString());
        log(newNumber.toString());
